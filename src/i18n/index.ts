...
void i18n
  ...
  .init({
    resources: {
      en: { common: enCommon, landing: enLanding, discover: enDiscover, settings: enSettings, connect: enConnect, games: enGames },
      es: { common: esCommon, landing: esLanding, discover: esDiscover, settings: esSettings, connect: esConnect, games: esGames },
      de: { common: deCommon, landing: deLanding, discover: deDiscover, settings: deSettings, connect: deConnect, games: deGames },
      fr: { common: frCommon, landing: frLanding, discover: frDiscover, settings: frSettings, connect: frConnect, games: frGames },
      pt: { common: ptCommon, landing: ptLanding, discover: ptDiscover, settings: ptSettings, connect: ptConnect, games: ptGames },
      zh: { common: zhCommon, landing: zhLanding, discover: zhDiscover, settings: zhSettings, connect: zhConnect, games: zhGames },
      ja: { common: jaCommon, landing: jaLanding, discover: jaDiscover, settings: jaSettings, connect: jaConnect, games: jaGames },
      ko: { common: koCommon, landing: koLanding, discover: koDiscover, settings: koSettings, connect: koConnect, games: koGames },
    },
    fallbackLng: 'en',
    defaultNS: 'common',
